...
/*!************************!*\
  !*** ./src/js/test.js ***!
  \************************/
/*! exports provided: squareNum, breakdown */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"squareNum\", function() { return squareNum; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"breakdown\", function() { return breakdown; });\nfunction squareNum(num) {\n  return num * num;\n}\nfunction breakdown(num) {\n  var items = [];\n\n  for (var i = 1; i < num; i++) {\n    items.push(i);\n    console.log('Pushed in: ', i);\n\n    if (items.reduce(function (prev, next) {\n      return prev + next;\n    }) > num) {\n      items.pop();\n      items.push(num - items.reduce(function (prev, next) {\n        return prev + next;\n      }));\n      break;\n    }\n  }\n\n  console.log(items);\n}\n\n//# sourceURL=webpack:///./src/js/test.js?");
